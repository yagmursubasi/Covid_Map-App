    ...
    <div className="bg-blue-900 text-white">
      <div className="container py-10 pb-16 md:pt-[100px] md:pb[120px] grid md:grid-cols-2 gap-5 ">
        <div className="flex flex-col gap-5 md:gap-10">
          <h1 className="text-3xl md:text-4xl text-nowrap">
          ...
          <div className="flex gap-5 ">
            <button className="hero-btn max-w-sm">
              <span className="flex-1 whitespace-nowrap">Nasıl Korunulur</span>
              <Arrow className="text-2xl" />
            </button>
            <button className=" hero-btn bg-transparent border border-white hover:bg-white hover:text-blue-900 max-w-sm">
